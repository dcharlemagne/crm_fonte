<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashBoardTelao.aspx.cs" Inherits="Intelbras.CRM2013.UI.Web.Pages.incident.DashBoardTelao" %>
...
<body>        
    <form id="form1" runat="server">
        <div id="proprietario" style="text-align:left; margin-left:20px; margin-top:10px; width:100%; height:30px;">
            ...
            <asp:DropDownList ID="DropDownList1Telao" AutoPostBack="true" OnSelectedIndexChanged="DropDownList" runat="server"></asp:DropDownList>
            <div id="contLinha" style="text-align:right;">
                <asp:Label ID="lbContLinhaTelao" runat="server" style="font-size:10px; margin-right:30px; margin-bottom:10px; position:relative;" Font-Bold="false" ></asp:Label>        
            </div>
        </div>
    ...
    <div id="div_body">
        ...
        <asp:Table runat="server" ID="grafico_dashboardTelao">
        ...
        <div>
            <asp:GridView ID="grid_ocorrenciasTelao" runat="server" ShowFooter="True" DataKeyNames="OcorrenciaId"
                ...
                OnSorting="grid_ocorrencias_SortingTelao" OnRowCommand="grid_ocorrencias_RowCommandTelao" OnRowDataBound="GridDataBound_RowDataBoundTelao"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Contador SLA" runat="server" ItemStyle-Width="105px">
                        <ItemTemplate>
                            <div id="grafico" runat="server">
                                <asp:Label ID="lbPorcentagem" runat="server" style="font-size:13px; position:relative; top:4px;" Font-Bold="true" Text='<%# Bind("Porcentagem") %>'></asp:Label>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <div id="mensagem" style="text-align:left;margin-left:20px;">
           <asp:Label ID="lbMensagemTelao" runat="server" style="font-size:12px; position:relative; top:6px;" Font-Bold="false" ></asp:Label>        
        </div>        
    </div>
    </form>
</body>
