...
namespace Intelbras.CRM2013.DAL
{
    ...
    public class RepHistoricoComprasTrimestre<T> : CrmServiceRepository<T>, IHistoricoComprasTrimestre<T>
    {
        ...
        public DataTable ListarPor(string ano, string trimestre)
        {
            ...
            strSql.Append(" group by CD_Unidade_Negocio, cd_canal, CD_Ano, CD_Trimestre ");

            return DataBaseSqlServer.executeQuery(strSql.ToString());
        }


        public T ObterPor(Guid UnidadeNeg, Int32 ano, Int32 trimestre)
        {
            ...
            ConditionExpression cond1 = new ConditionExpression("itbc_unidadedenegocio", Microsoft.Xrm.Sdk.Query.ConditionOperator.Equal, UnidadeNeg);
            ...
            ConditionExpression cond3 = new ConditionExpression("itbc_trimestre", Microsoft.Xrm.Sdk.Query.ConditionOperator.Equal, trimestre);
