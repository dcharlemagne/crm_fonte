...
{
    public class RepArquivoDeEstoqueGiro<T> : CrmServiceRepository<T>, IArquivoDeEstoqueGiro<T>
    {
        ...
        public Boolean AlterarStatus(Guid ArquivoDeEstoqueGiroId, int status)
        {
