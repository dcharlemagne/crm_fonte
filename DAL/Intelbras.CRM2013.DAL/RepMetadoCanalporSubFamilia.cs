...
{
    public class RepMetadoCanalporSubFamilia<T> : CrmServiceRepository<T>, IMetadoCanalporSubFamilia<T>
    {
        ...
        public T Obterpor(Guid canalId, Guid familiaId, Guid metadocanalporfamiliaId, Guid segmentoId, Guid subfamiliaId, int trimestre)
        {
            ...
            query.Criteria.AddCondition("itbc_metadocanalporfamiliaid", ConditionOperator.Equal, metadocanalporfamiliaId);
        ...
        public T Obterpor(Guid unidadenegocioId, Guid canalId, int ano, int trimestre, Guid segmentoId, Guid familiaId, Guid subfamiliaId)
        {
            var query = GetQueryExpression<T>(true);
        ...
        public List<T> ListarSubFamilia(Guid metaunidadeId)
        {
            ...
            query.AddLink("itbc_metadocanalporfamilia", "itbc_metadocanalporfamiliaid", "itbc_metadocanalporfamiliaid")
        ...
        public T ObterPor(Guid canalId, Guid subfamiliaId, Guid metadotrimestreId)
        {
            var query = GetQueryExpression<T>(true);
        ...
        public List<T> ListarPor(Guid metacanalfamiliaId)
        {
            var query = GetQueryExpression<T>(true);

            #region Condições
            query.Criteria.AddCondition("statecode", ConditionOperator.Equal, 0);
            query.Criteria.AddCondition("itbc_metadocanalporfamiliaid", ConditionOperator.Equal, metacanalfamiliaId);
            #endregion
        ...
        public List<T> ListarPorUnidadeNegocio(Guid unidadeNegocioId, int ano, Domain.Enum.OrcamentodaUnidade.Trimestres trimestre, Guid familiaProdutoId)
        {
            var query = GetQueryExpression<T>(true);
        ...
        public List<T> ListarPorUnidadeNegocioSubfamilia(Guid unidadeNegocioId, int ano, Domain.Enum.OrcamentodaUnidade.Trimestres trimestre, Guid subfamiliaProdutoId)
        {
            var query = GetQueryExpression<T>(true);
            ...
            query.Criteria.AddCondition("itbc_trimestre", ConditionOperator.Equal, (int)trimestre);
            query.Criteria.AddCondition("itbc_unidadedenegociosid", ConditionOperator.Equal, unidadeNegocioId);
            query.Criteria.AddCondition("itbc_subfamiliaid", ConditionOperator.Equal, subfamiliaProdutoId);
        ...
        public List<T> ListarMetaCanalSubFamilia(int ano, int trimestre)
        {
            var query = GetQueryExpression<T>(true);
        ...
        /********************      ACESSO SQL      ********************/
        public DataTable ListarMetaCanalSubFamiliaDW(int ano, int trimestre, List<MetadaUnidade> lstMetadaUnidade)
        {
            StringBuilder strSql = new StringBuilder();
            string commandIn = string.Empty;

            strSql.Append("Select  cd_ano,cd_unidade_negocio,CD_Emitente,cd_trimestre,cd_segmento,CD_familia,CD_subfamilia ");
            ...
            strSql.Append("Group By   cd_ano,cd_unidade_negocio,CD_Emitente,cd_trimestre,cd_segmento,CD_familia,CD_subfamilia ");
