...
namespace Intelbras.CRM2013.DAL
{
    ...
    public class RepHistoricoComprasProduto<T> : CrmServiceRepository<T>, IHistoricoComprasProduto<T>
    {
        ...
        public DataTable ListarPor(string ano, string trimestre)
        {
            ...
            strSql.Append(" group by CD_item, CD_Ano, CD_Trimestre, cd_canal ");

            return DataBaseSqlServer.executeQuery(strSql.ToString());
        }

        public T ObterPor(Int32 trimestre, Int32 ano, Guid produto)
        {
