if (typeof (LinhaCorteRevenda) == "undefined") { LinhaCorteRevenda = {}; }
...
LinhaCorteRevenda = {
    ...
    OnSave: function (context) {
        ...
        LinhaCorteRevenda.DisabledEnabled(false);
        ...
        LinhaCorteRevenda.DisabledEnabled(true);
        LinhaCorteRevenda.ForceFieldSave();
    }
}