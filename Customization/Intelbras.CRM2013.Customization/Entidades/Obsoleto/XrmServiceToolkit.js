...
XrmServiceToolkit.Soap = function () {
    ...
    var associate = function (relationshipName, targetEntityName, targetId, relatedEntityName, relatedEntities, callback) {
        ///<summary>
        ...
        /// that is used for associate operations.
        /// </param>
        ///<param name="relationshipEntities" type="Array">
        ...
        /// A Function used for asynchronous request. If not defined, it sends a synchronous request.
        /// </param>
        var relatedEntities = relatedEntities;
    ...
    var disassociate = function (relationshipName, targetEntityName, targetId, relatedEntityName, relatedEntities, callback) {
        ///<summary>
