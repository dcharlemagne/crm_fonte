if (typeof (ProdutoTreinamentoCertificacao) == "undefined") { ProdutoTreinamentoCertificacao = {}; }

ProdutoTreinamentoCertificacao = {
    ...
    OnSave: function (context) {
        ...
        ProdutoTreinamentoCertificacao.DisabledEnabled(false);

        Xrm.Page.getAttribute("itbc_name").setValue(Util.funcao.ContatenarCampos("itbc_productid", " - "));

        ProdutoTreinamentoCertificacao.DisabledEnabled(true);
        ProdutoTreinamentoCertificacao.ForceFieldSave();
    }
