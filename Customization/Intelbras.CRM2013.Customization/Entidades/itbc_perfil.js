...
Perfil = {
    ...
    OnSave: function (context) {
        ...
        Perfil.DisabledEnabled(false);

        Xrm.Page.getAttribute("itbc_name").setValue(Util.funcao.ContatenarCampos("itbc_classificacaoid,itbc_categoriaid", " - "));

        Perfil.DisabledEnabled(true);
        Perfil.ForceFieldSave();
    }
}