if (typeof (HistoricoCompraUnidade) == "undefined") { HistoricoCompraUnidade = {}; }

HistoricoCompraUnidade = {
    ...
    OnSave: function (context) {
        ...
        HistoricoCompraUnidade.DisabledEnabled(false);

        Xrm.Page.getAttribute("itbc_name").setValue(Util.funcao.ContatenarCampos("itbc_businessunitid,itbc_ano", " - "));

        HistoricoCompraUnidade.DisabledEnabled(true);
        HistoricoCompraUnidade.ForceFieldSave();
    }
