...
{
    [LogicalEntity("itbc_orcamentoporproduto")]
    public class OrcamentodaUnidadeporProduto : DomainBase
    {
        #region Construtores

        private RepositoryService RepositoryService { get; set; }

        public OrcamentodaUnidadeporProduto(string organization, bool isOffline)
            : base(organization, isOffline)
        {
            RepositoryService = new RepositoryService(organization, isOffline);
        }
        public OrcamentodaUnidadeporProduto(string organization, bool isOffline, object provider)
        ...
        #region Atributos
        [LogicalAttribute("itbc_orcamentoporprodutoid")]
        public Guid? ID { get; set; }
        
        [LogicalAttribute("itbc_name")]
        public String Nome { get; set; }
        
        [LogicalAttribute("itbc_OrcamentoporSubFamilia")]
        public Lookup OrcamentoporSubFamilia { get; set; }
