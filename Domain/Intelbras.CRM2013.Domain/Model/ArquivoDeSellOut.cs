...
{
    [LogicalEntity("itbc_arquivodesellout")]
    public class ArquivoDeSellOut : IntegracaoBase
    {
        #region Construtores

        private RepositoryService RepositoryService { get; set; }

        public ArquivoDeSellOut() { }

        public ArquivoDeSellOut(string organization, bool isOffline)
            : base(organization, isOffline)
        {
            RepositoryService = new RepositoryService(organization, isOffline);
        }

        public ArquivoDeSellOut(string organization, bool isOffline, object provider)
        ...
        [LogicalAttribute("itbc_arquivodeselloutid")]
        ...
        [LogicalAttribute("itbc_quantidadedelinhasduplicadas")]
        public int? QuantidadeLinhasDuplicadas { get; set; }
