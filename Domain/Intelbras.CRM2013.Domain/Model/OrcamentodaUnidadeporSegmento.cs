...
{
    [LogicalEntity("itbc_orcamentoporsegmento")]
    public class OrcamentodaUnidadeporSegmento : DomainBase
    {
        #region Construtores

        private RepositoryService RepositoryService { get; set; }

        public OrcamentodaUnidadeporSegmento(string organization, bool isOffline)
            : base(organization, isOffline)
        {
            RepositoryService = new RepositoryService(organization, isOffline);
        }
        public OrcamentodaUnidadeporSegmento(string organization, bool isOffline, object provider)
        ...
        #region Atributos
        [LogicalAttribute("itbc_orcamentoporsegmentoid")]
        ...
        [LogicalAttribute("itbc_UltAtualizacaooIntegracao")]
