...
namespace Intelbras.CRM2013.Domain.Model
{
    ...
    public class Product : DomainBase
    {
        ...
        public Product(string organization, bool isOffline)
            : base(organization, isOffline)
        {
            RepositoryService = new RepositoryService(organization, isOffline);
        }

        public Product(string organization, bool isOffline, object provider)
        ...
        private Domain.Model.PotencialdoKARepresentante _PotencialdoKARepresentante = null;
        public Domain.Model.PotencialdoKARepresentante objPotencialdoKARepresentante
        {
            get
            {
                //if (_PotencialdoKARepresentante == null && Segmento.Id != null && Segmento.Id != Guid.Empty)
                //    _PotencialdoKARepresentante = RepositoryService.PotencialdoKARepresentante.ObterPorSegmento(Segmento.Id);
                return _PotencialdoKARepresentante;
            }
        }

        private Domain.Model.PotencialdoKAporTrimestre _PotencialdoKAporTrimestre1 = null;
        public Domain.Model.PotencialdoKAporTrimestre objPotencialdoKAporTrimestre1
        {
            get
            {
                //if (_PotencialdoKAporTrimestre1 == null && objPotencialdoKARepresentante.ID != null && objPotencialdoKARepresentante.ID != Guid.Empty)
                //    _PotencialdoKAporTrimestre1 = RepositoryService.PotencialdoKAporTrimestre.ObterPor(objPotencialdoKARepresentante.ID.Value, Guid.Empty, (int)Enum.OrcamentodaUnidade.Trimestres.Trimestre1);
                return _PotencialdoKAporTrimestre1;
            }
        }
        ...
        public string DescricaoPoliticaPosVenda
        {
            get { return (PoliticaPosVenda.HasValue ? ((Enum.PoliticaPosVenda)PoliticaPosVenda).ToString() : string.Empty); }
            set { }
        }
        ...
        public FamiliaComercial DadosFamiliaComercial
        {
            get
            {
                if (dadosFamiliaComercial == null && FamiliaComercial != null && this.Id != Guid.Empty)
                    dadosFamiliaComercial = (new RepositoryService(OrganizationName, IsOffline)).FamiliaComercial.Retrieve(FamiliaComercial.Id);

                return dadosFamiliaComercial;
            }

            set { dadosFamiliaComercial = value; }
        }
        ...
        [LogicalAttribute("itbc_linha_unidade_negocioid")]
        public Lookup LinhaComercialId { get; set; }

        private LinhaComercial _LinhaComercial = null;
        public LinhaComercial LinhaComercial
        {
            get
            {
                if (LinhaComercialId != null && _LinhaComercial == null && this.Id != Guid.Empty)
                    _LinhaComercial = (new CRM2013.Domain.Servicos.RepositoryService()).LinhaComercial.Retrieve(this.LinhaComercialId.Id);
                return _LinhaComercial;
            }
            set { _LinhaComercial = value; }
        }

        [LogicalAttribute("itbc_tipo_item")]
        public int? TipoItem { get; set; }

        [LogicalAttribute("itbc_linha_produto")]
        public Lookup LinhaProduto { get; set; }
        #endregion
    }
}
