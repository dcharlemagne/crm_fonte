...
{
    public class MSG0069 : Base, IBase<Message.Helper.MSG0068, Domain.Model.FornecedorCanal>
    {
        #region Propriedades
        ...
        public MSG0069(string org, bool isOffline)
            : base(org, isOffline)
        {
        ...
        public string Executar(string mensagem, string numeroMensagem, Domain.Model.Usuario usuario)
        {
            ...
            return CriarMensagemRetorno<Pollux.MSG0069R1>(numeroMensagem, retorno);
        }
