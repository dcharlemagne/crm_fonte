    ...
    public class PostUpdate : IPlugin
    {
        public void Execute(IPluginExecutionContext context)
        {
            try
            {
                ...
                if (context.PostEntityImages.Properties.Contains("Target") && context.PostEntityImages.Properties["Target"] is DynamicEntity) entity = (DynamicEntity)context.PostEntityImages.Properties["Target"];
